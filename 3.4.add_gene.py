...
parser = argparse.ArgumentParser(description="Add genes for the selected regions in xpclr")

parser.add_argument('--input', '-i', type=str, required=True, help="Input xpclr selected region file name (e.g., merged_broomcorn_win100k_2k.xpclr_selected_region.txt")
parser.add_argument('--output', '-o', type=str, required=True, help="Ouput file for selected regions add genes (e.g. merged_broomcorn_win100k_2k.xpclr_selected_region_add_genes.txt)")
